...
const ImportGuestTrainModal = ({ isOpen, setIsOpen, refreshData }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!isValid) {
      ...
      try {
        ...
        const response = await ApiServices.guestTrain.ImportExcel(formData);
        const { data } = response;
        ...
        if (response?.code === 200) {
          ...
          openSuccessModal({
            title: "Success!",
            message: "Guest Train imported successfully",
...
export default ImportGuestTrainModal;
