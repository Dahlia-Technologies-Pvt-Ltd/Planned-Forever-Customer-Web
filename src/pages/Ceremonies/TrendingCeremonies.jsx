...
import { ChevronDownIcon, ChevronLeftIcon, ChevronRightIcon, ArrowLeftIcon, ChevronUpIcon, MagnifyingGlassIcon } from "@heroicons/react/24/outline";
...
const Ceremonies = () => {
  ...
  // Context
  const { eventSelect, loading, setLoading, setBtnLoading, btnLoading, closeSuccessModel, openSuccessModal, setErrorMessage } = useThemeContext();
                      ...
                      items.map((item, index) => (
                        ...
                        >
                          ...
                          <td className="py-3 pl-4 3xl:px-4">
                            <p className="line-clamp-1 text-xs font-normal text-primary-color 3xl:text-sm">{item?.trending_significance}</p>
                          </td>
          ...
          <div className="card min-h-[82vh]">
            <>
              <div className="h-[70vh] overflow-y-auto">
                ...
                <div>
                  <TitleValue title="Ceremony Significance" value={detail?.trending_significance} />
                </div>
