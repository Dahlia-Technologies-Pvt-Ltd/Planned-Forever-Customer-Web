...
// Table Head
const TABLE_HEAD = ["Category Name", "Sub Category Name", "Further Classification", "Actions"];
...
const FurtherClassification = () => {
  ...
  const handleDeleteFurtherClassification = async () => {
    try {
      setBtnLoading(true);
  ...
  return (
    <>
          ...
          <div className="card min-h-[82vh]">
            <div className="flex justify-between">
              ...
              <div className="flex items-center justify-between w-full">
                <Button title="Add Further Classification" onClick={() => setOpenAddNewModal({ open: true, data: null })} />
      ...
      <ConfirmationModal
        ...
        handleSubmit={handleDeleteFurtherClassification}
