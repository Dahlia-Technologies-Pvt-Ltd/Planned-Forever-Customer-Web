...
import { VENDOR_PRINT } from "../../../routes/Names";
...
// Table Head
const TABLE_HEAD = ["Vendor Name", "Category", "Sub Category", "Further Classification", "Custom Tags"];
                ...
                <div className="h-[70vh] overflow-y-auto">
                  <div className="mt-6">
                    ...
                    <div className="flex flex-wrap gap-5">
                      <TitleValue title="Vendor Name" value={detail?.name || "-"} />
                      <TitleValue title="Vendor Address" value={detail?.address || "-"} />
                      <TitleValue title="Country Code" value={detail?.contact?.countryCode || "-"} />
                      <TitleValue title="Contact Number" value={detail?.contact?.phone || "-"} />
                    </div>
                  </div>

                  <div className="mt-6">
                    <h2 className="sub-heading mb-5">1st Contact Person</h2>
                    <div className="flex flex-wrap gap-5">
                      <TitleValue title="Name" value={detail?.["1st_contact_person_name"] || "-"} />
                      <TitleValue title="Designation" value={detail?.["1st_contact_person_designation"] || "-"} />
                      <TitleValue title="Country Code" value={detail?.["1st_contact_person_contact_number"]?.countryCode || "-"} />
                      <TitleValue title="Contact Number" value={detail?.["1st_contact_person_contact_number"]?.phone || "-"} />
                    </div>
                  </div>

                  <div className="mt-6">
                    <h2 className="sub-heading mb-5">2nd Contact Person</h2>
                    <div className="flex flex-wrap gap-5">
                      <TitleValue title="Name" value={detail?.["2nd_contact_person_name"] || "-"} />
                      <TitleValue title="Designation" value={detail?.["2nd_contact_person_designation"] || "-"} />
                      <TitleValue title="Country Code" value={detail?.["2nd_contact_person_contact_number"]?.countryCode || "-"} />
                      <TitleValue title="Contact Number" value={detail?.["2nd_contact_person_contact_number"]?.phone || "-"} />
                    </div>
                  </div>
                  ...
                  <div className="mt-6">
                    ...
                    <div className="grid grid-cols-1 gap-5">
                      <div className="w-full space-y-2">
                        <h3 className="text-xs text-info-color">Tags</h3>
